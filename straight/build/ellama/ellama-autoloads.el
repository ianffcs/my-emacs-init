...
(autoload 'ellama-blueprint-remove "ellama-blueprint" "\
...

;;; Generated autoloads from ellama-skills.el

(autoload 'ellama-skills-generate-prompt "ellama-skills" "\
Generate the <available_skills> XML block for the system prompt.")
(register-definition-prefixes "ellama-skills" '("ellama-"))


;;; Generated autoloads from ellama-tools.el

(autoload 'ellama-tools-enable-by-name "ellama-tools" "\
Add to `ellama-tools-enabled' each tool that matches NAME.

(fn &optional NAME)" t)
(autoload 'ellama-tools-disable-by-name "ellama-tools" "\
Remove from `ellama-tools-enabled' each tool that matches NAME.

(fn &optional NAME)" t)
(autoload 'ellama-tools-enable-all "ellama-tools" "\
Enable all available tools." t)
(autoload 'ellama-tools-disable-all "ellama-tools" "\
Disable all enabled tools." t)
(register-definition-prefixes "ellama-tools" '("ellama-"))
...
;;; Generated autoloads from ellama-transient.el
 ...
 (autoload 'ellama-transient-tools-menu "ellama-transient" nil t)
