...
The keyword and its definition are configured in `aider-todo-keyword-pair`." t)
...

;;; Generated autoloads from aider-highlight-changes.el

(autoload 'aider-compare-search-replace-blocks "aider-highlight-changes" "\
Compare SEARCH and REPLACE blocks using diff program.
Creates two temporary files with the content and calls diff to show differences." t)
(register-definition-prefixes "aider-highlight-changes" '("aider-"))
