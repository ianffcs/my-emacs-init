...

;;; Generated autoloads from emms-filters.el

(register-definition-prefixes "emms-filters" '("emms-filters-"))
...

;;; Generated autoloads from emms-lyrics-lrclib.el

(autoload 'emms-lyrics-lrclib-get "emms-lyrics-lrclib" "\
...
(fn &optional TRACK FORCE INTERACTIVE)" t)
(register-definition-prefixes "emms-lyrics-lrclib" '("emms-lyrics-lrclib-"))
...

;;; Generated autoloads from emms-radio-browser.el

(autoload 'emms-radio-browser-search-by-name "emms-radio-browser" "\
Search radio-browser for stations matching NAME.

Switches to an EMMS playlist containing the results.

(fn NAME)" t)
(autoload 'emms-radio-browser-search-by-url "emms-radio-browser" "\
Search radio-browser for stations matching URL.

Switches to an EMMS playlist containing the results.

(fn URL)" t)
(autoload 'emms-radio-browser-full-search "emms-radio-browser" "\
Construct a search query by filling in a form.

Optionally dispatch it to the radio-browser server and switch to an
EMMS playlist of results." t)
(register-definition-prefixes "emms-radio-browser" '("emms-radio-browser-"))
...

;;; Generated autoloads from emms-volume-mpv.el

(autoload 'emms-volume-mpv-change "emms-volume-mpv" "\
Change volume by AMOUNT using mpv process PROC.

(fn AMOUNT &optional PROC)")
(register-definition-prefixes "emms-volume-mpv" '("emms-volume-mpv-"))
