;;; cargo-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
(fn DIRECTORY &optional BIN)" t)
(autoload 'cargo-process-run "cargo-process" "\
Run the Cargo run command.
With the prefix argument, modify the command's invocation.
Cargo: Build and execute src/main.rs." t)
...
Requires cargo-audit to be installed." t)
...
(fn &optional ALL CRATES)" t)
(autoload 'cargo-process-repeat "cargo-process" "\
Run the last cargo-process command." t)
