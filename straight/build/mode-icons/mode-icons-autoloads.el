;;; mode-icons-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
`Mode-Icons mode' mode.  If the prefix argument is positive, enable the
