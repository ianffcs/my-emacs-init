...

;;; Generated autoloads from fennel-ls-flymake.el

(autoload 'fennel-ls-flymake "fennel-ls-flymake" "\
Setup fennel-ls integration with Flymake." t)
(register-definition-prefixes "fennel-ls-flymake" '("fennel-ls-flymake-"))
...
To check whether the minor mode is enabled in the current buffer,
evaluate the variable `fennel-proto-repl-minor-mode'.
