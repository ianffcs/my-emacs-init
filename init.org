...
(use-package lsp-mode
  ...
  :hook ((clojure-mode . lsp)
         ...
         (go-mode . lsp)
         (c++-mode . lsp))
  :custom ((lsp-clojure-server-command '("java" "-jar" "/home/ianffcs/Downloads/clj-kondo-lsp-server-2020.06.21-standalone.jar")))
  :config
  (progn (dolist (m '(clojure-mode
                      clojurescript-mode))
...
(setq org-reveal-mathjax t
              ...
              org-re-reveal-root "http://cdn.jsdelivr.net/reveal.js@4.0.2/")
...
(setq reveal-path
      (concat user-emacs-directory "elpa/emacs-reveal"))
(use-package emacs-reveal
  :straight (:type built-in)
  :load-path reveal-path)
